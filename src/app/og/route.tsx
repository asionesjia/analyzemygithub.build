...
const inter600 = fetch(new URL(`../../assets/fonts/Inter-SemiBold.ttf`, import.meta.url)).then(
  (res) => res.arrayBuffer(),
)
...
const image = fetch(new URL('../../assets/images/og-bg-2.jpg', import.meta.url)).then((res) =>
  res.arrayBuffer(),
)
